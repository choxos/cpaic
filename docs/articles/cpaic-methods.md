...
by construction. All four outcome families are supported (survival
through the exponential / person-time formulation). A component whose
effect-modifier interaction is informed only by aggregate data is weakly
identified and relies on the regression prior.
...
<https://doi.org/10.1002/bimj.202000136>.
