...
modifiers using anchored population-adjustment methods (STC and MAIC;
ML-NMR is in development). The result is an indirect comparison that is
both connected and population-adjusted.
...
- [`vignette("cpaic-methods")`](https://choxos.github.io/cpaic/articles/cpaic-methods.md)
  (in preparation) covers the statistical framework in depth.
