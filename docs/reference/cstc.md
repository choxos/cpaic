...
(reweighting) this is the regression-/G-computation route. It is
implemented natively here because
[`mlumr::stc()`](https://choxos.github.io/mlumr/reference/stc.html)
targets the *unanchored* two-trial case; the delta-method machinery is
adapted from that package.
