...
#>          A   -0.166 0.380 -0.968  0.503
#>          B   -0.306 0.269 -0.842  0.205
#>          M   -0.219 0.136 -0.480  0.040
#>          S   -0.340 0.123 -0.571 -0.088
```
...
#>        B+M      Std+B   -0.332  -0.345 -0.330        0.013       0.002        0.013
#>      B+M+A      Std+B   -0.543  -0.512 -0.620        0.031       0.077        0.077
#>      B+M+S      Std+B   -0.610  -0.624 -0.608        0.014       0.002        0.014
#>        Std      Std+B    0.110   0.155  0.090        0.045       0.020        0.045
#>      Std+M      Std+B   -0.222  -0.190 -0.240        0.033       0.018        0.033
#>  estimable
#>       TRUE
#>      FALSE
#>       TRUE
...
#>    mspline      -0.8     2.4    0.63 |elpd_diff| < 4
#> 
...
#>   DIC: 5922.3
#>   Mean deviance: 5904.8
#>   Effective parameters (pV): 17.5
dic(fit_ms)
#> Deviance information criterion
#>   DIC: 5922.8
